...
const Play = function( props: IPageProps ) {
    ...
    let levelChallenges = selectedLevel && selectedLevel !== 'All' ? challenges.filter(challenge => challenge.level == selectedLevel ) :  challenges
    let continentChallenges = selectedContinent && selectedLevel !== 'All' ? challenges.filter(challenge => challenge.continent == selectedContinent ) :  challenges

    console.log('level challenges: ',selectedLevel , levelChallenges)
            ...
            <div className="lg:w-3/4 max-lg:px-4">
                ...
                <div className="challenges">
                    <div className='by-difficulty mb-5'>
                        <p className='mb-2 text-xl font-xl font-bold italic'>Challenges by Difficulty</p>
                    ...
                    <div className='by-continent'>
                        <p className='mb-2 text-xl font-xl font-bold italic'>Challenges by Continent</p>
                        <div className="filters w-full flex mb-5 dark:text-black">
                            <div className="flex w-1/2 items-center justify-center">
                                <div className='w-full flex items-center justify-start text-xs'>
                                    <span className='text-sm dark:text-white hidden lg:block'>Continent: &nbsp;</span>
