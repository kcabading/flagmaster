...
const Privacy = () => {
    ...
    return (
        <>
            <div className="w-full lg:w-3/4 max-lg:px-4">
            <h1 className="font-bold">Privacy Policy</h1>
<p>This Privacy Policy is prepared by Flagmaster and whose registered address is Mandaluyong Philippines (“We”) are committed to protecting and preserving the privacy of our visitors when visiting our site or communicating electronically with us.
...
Contact
Questions, comments, and requests regarding this privacy policy are welcomed and should be addressed to Kristian Cabading (kcabading@gmail.com).</p>
            </div>
        </>
    )
}
